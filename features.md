...
2. Community types, communtity and server - community owner features, community member features, create and manage server , roles and permission system ,custom  emoji and stickers , threaded conversation ,server modartion tools 
...
5. customizability - themes , profile and status , server boosters , 
6. security and privacy - end to end encryption , two factor authentication , data privacy and security 
7. notifications - (show mention roles) push notifications , desktop notifications , mobile notifications
8. Ai integration - chatbot , image generation , voice to text , text to speech , smart reply , smart search, separate ai and ai assistant mentions in chat
